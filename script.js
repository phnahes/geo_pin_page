...
const URL_DADOS_JSON = "dados.json"; // Certifique-se que o arquivo está na mesma pasta do script
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    // Carregar os dados locais do arquivo JSON
    fetch(URL_DADOS_JSON)
        ...
        .then(dados => {
            ...
            fetch(URL_IBGE_JSON)
                .then(response => response.json())
                .then(municipios => {
                    // Percorre os dados do arquivo e adiciona LAT/LONG a cada ponto pelo Código IBGE
                    dados.forEach(ponto => {
                        ...
                        if (ponto.lat && ponto.lng) {
                            ...
                            let popupContent = `
                                <div class="popup-container">
                                    ...
                                    <p><strong>População 2010 IBGE:</strong> ${ponto.populacao_2010.toLocaleString()} habitantes</p>
